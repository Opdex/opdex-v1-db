...
delete from vault_governance_proposal where Id > 0;
delete from vault_governance_proposal_pledge where Id > 0;
delete from vault_governance_proposal_vote where Id > 0;
